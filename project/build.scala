...
object ScalatraBuild extends Build {
  ...
  object Dependencies {
    ...
    lazy val jettyPlus                  =  "org.eclipse.jetty"       %  "jetty-plus"         % "9.1.1.v20140108"
    lazy val jettyServlet               =  "org.eclipse.jetty"       %  "jetty-servlet"      % jettyVersion
    lazy val jettyWebsocket             =  "org.eclipse.jetty.websocket" %"websocket-server" % "9.1.1.v20140108"
...
//    lazy val swaggerCore                =  "com.wordnik"             % "swagger-core"        % swaggerVersion       cross swaggerCross exclude("log4j", "log4j") exclude("org.slf4j", "slf4j-log4j12")
    ...
    lazy val testng                     =  "org.testng"              %  "testng"             % "6.8.7"
    ...
    private val httpcomponentsVersion = "4.3.2"

    private val jettyVersion = "9.1.2.v20140210"

    private val json4sVersion = "3.2.7"
